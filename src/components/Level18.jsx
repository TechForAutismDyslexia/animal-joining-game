...
import tail from '../assets/images/elephanttail.png'; 
import head from '../assets/images/elephanthead.png';
import headshad from '../assets/images/elephantshad.png';
import deerhead from '../assets/images/henhead.png';
import deerhead1 from '../assets/images/dolphinhead.png';
...
const Level8 = ({ onNext, onPrev,updateTrialCount,throwConfetti }) => {
  ...
  const handleResize = () => {
    ...
    setHeadShadowPosition({ x: 371 * scale, y: 200 * scale });
    setHeadPosition({ x: 1300 * scale, y: 200 * scale });
    setDeerPosition1({ x: 900 * scale, y: 350 * scale });
    setDeerPosition2({ x: 900 * scale, y: 50 * scale });
    originalDeerPositionRef1.current = { x: 900 * scale, y: 350 * scale };
    originalDeerPositionRef2.current = { x: 900 * scale, y: 50 * scale };

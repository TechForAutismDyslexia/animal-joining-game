...
import tail from '../assets/images/moosetail.png'; 
import head from '../assets/images/moosehead.png';
import headshad from '../assets/images/mooseshad.png';
import deerhead from '../assets/images/goat14.png';
...
const Level3 = ({ onNext, onPrev,updateTrialCount}) => {
  ...
  const handleResize = () => {
    ...
    setTailPosition({ x: 550 * scale, y: 100 * scale });

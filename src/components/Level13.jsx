...
import tail from '../assets/images/eaglehead.png'; 
import head from '../assets/images/eagletail.png';
import headshad from '../assets/images/eagleshad.png';
import deerhead from '../assets/images/swantail.png';
...
const Level3 = ({ onNext, onPrev,updateTrialCount }) => {
  ...
  const handleResize = () => {
    ...
    setHeadShadowPosition({ x: 463 * scale, y: 100 * scale });

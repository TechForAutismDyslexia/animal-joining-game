...
import tail from '../assets/images/skunkhead.png'; 
import head from '../assets/images/skunktail.png';
import headshad from '../assets/images/skunkshad.png';
import deerhead from '../assets/images/fishtail.png';
import deerhead1 from '../assets/images/goosetail.png';

const Level8 = ({ onNext, onPrev,updateTrialCount,throwConfetti }) => {
  ...
  const handleResize = () => {
    ...
    setTailPosition({ x: 369 * scale, y: 200 * scale });
    setHeadShadowPosition({ x: 189 * scale, y: 200 * scale });
    setHeadPosition({ x: 900 * scale, y: 10 * scale });
    setDeerPosition1({ x: 900 * scale, y: 450 * scale });
    setDeerPosition2({ x: 1200 * scale, y: 150 * scale });
    originalDeerPositionRef1.current = { x: 900 * scale, y: 450 * scale };
    originalDeerPositionRef2.current = { x: 1200 * scale, y: 150 * scale };

...
import tail from '../assets/images/birdtail.png'; 
import head from '../assets/images/birdhead.png';
import headshad from '../assets/images/birdshad.png';
import deerhead from '../assets/images/camelhead.png';
import deerhead1 from '../assets/images/goat.png';
...
const Level8 = ({ onNext, onPrev,updateTrialCount,throwConfetti }) => {
  ...
  const handleResize = () => {
    ...
    setTailPosition({ x: 381.6 * scale, y: 200 * scale });
    setHeadShadowPosition({ x: 189 * scale, y: 200 * scale });
    setHeadPosition({ x: 900 * scale, y: 450 * scale });
    setDeerPosition1({ x: 1300 * scale, y: 250 * scale });
    setDeerPosition2({ x: 900 * scale, y: 10 * scale });
    originalDeerPositionRef1.current = { x: 1300 * scale, y: 250 * scale };

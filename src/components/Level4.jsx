...
import tail from '../assets/images/goat.png'; 
import head from '../assets/images/goattail.png';
import headshad from '../assets/images/goatshad.png';
import deerhead from '../assets/images/sheep.png';
const Level3 = ({ onNext, onPrev,updateTrialCount }) => {
  ...
  return (
    <div style={{ position: 'relative', backgroundColor: '#D8F7F2', height: 'calc(100vh - 100px)', zIndex: 1 }}>
      ...
      <div style={{position: 'absolute',top: `${150 * scale}px`,right: '10px',fontSize: `${50 * scale}px`,zIndex: 2}}>
        Trials: {trialCount}
      </div>
    </div>
  );

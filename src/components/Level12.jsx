...
import tail from '../assets/images/goosetail.png'; 
import head from '../assets/images/goosehead.png';
import headshad from '../assets/images/gooseshad.png';
import deerhead from '../assets/images/henhead2.png';
import deerhead1 from '../assets/images/duckhead.png';
...
const Level3 = ({ onNext, onPrev,updateTrialCount }) => {
  ...
  const handleResize = () => {
    ...
    setTailPosition({ x: 180 * scale, y: 200 * scale });
    setHeadShadowPosition({ x: 425 * scale, y: 200 * scale });
    setHeadPosition({ x: 900 * scale, y: 10 * scale });
    setDeerPosition1({ x: 1200 * scale, y: 200 * scale });
    setDeerPosition2({ x: 900 * scale, y: 400 * scale });
    originalDeerPositionRef1.current = { x: 1200 * scale, y: 200 * scale };

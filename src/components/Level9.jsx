...
import tail from '../assets/images/sealtail.png'; 
import head from '../assets/images/sealhead.png';
import headshad from '../assets/images/sealshad.png';
import deerhead from '../assets/images/deer2head.png';
import deerhead1 from '../assets/images/cowhead.png';
const Level8 = ({ onNext, onPrev ,updateTrialCount,throwConfetti}) => {
  ...
  const handleResize = () => {
    ...
    setTailPosition({ x: 339 * scale, y: 200 * scale });
    setHeadShadowPosition({ x: 120 * scale, y: 200 * scale });
    setHeadPosition({ x: 900 * scale, y: 450 * scale });
    setDeerPosition1({ x: 900 * scale, y: 10 * scale });
    setDeerPosition2({ x: 1200 * scale, y: 300 * scale });
    originalDeerPositionRef1.current = { x: 900 * scale, y: 10 * scale };
    originalDeerPositionRef2.current = { x: 1200 * scale, y: 300 * scale };

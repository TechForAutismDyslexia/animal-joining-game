    ...
    <div style={{ position: 'relative', backgroundColor: '#D8F7F2', height: 'calc(100vh - 100px)', zIndex: 1 }}>
      <div
        style={{
          ...
          background: 'url(images/tigerhead.png) no-repeat',
      ...
      <div
        style={{
          ...
          width: `${imageSize.width}px`,
          height: `${imageSize.height}px`,
          background: 'url(images/tigerrealshad.png) no-repeat',
          backgroundSize: 'contain',
      ...
      <Draggable position={deerPosition1} onStop={onStopDeer1} nodeRef={deerRef1}>
        <div
          ...
          style={{
            ...
            width: `${imageSize.width}px`,
            height: `${imageSize.height}px`,
            background: 'url(images/liontail.png) no-repeat',
            backgroundSize: 'contain',
          }}
        />
      </Draggable>
      <Draggable position={deerPosition2} onStop={onStopDeer2} nodeRef={deerRef2}>
        <div
          ...
          style={{
            ...
            width: `${imageSize.width}px`,
            height: `${imageSize.height}px`,
            background: 'url(images/hyenatail.png) no-repeat',
            backgroundSize: 'contain',
          }}
        />
      </Draggable>

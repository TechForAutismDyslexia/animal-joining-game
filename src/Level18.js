    ...
    <div style={{ position: 'relative', backgroundColor: '#D8F7F2', height: 'calc(100vh - 100px)', zIndex: 1 }}>
      <div
        style={{
          ...
          background: 'url(images/elephanttail.png) no-repeat',
      ...
      <div
        style={{
          ...
          width: `${imageSize.width}px`,
          height: `${imageSize.height}px`,
          background: 'url(images/elephantshad.png) no-repeat',
          backgroundSize: 'contain',
      ...
      <Draggable position={headPosition} onStop={onStopHead} nodeRef={headRef}>
        <div
          ...
          style={{
            ...
            width: `${imageSize.width}px`,
            height: `${imageSize.height}px`,
            background: 'url(images/elephanthead.png) no-repeat',
            backgroundSize: 'contain',
          }}
        />
      </Draggable>
      ...
      <Draggable position={deerPosition2} onStop={onStopDeer2} nodeRef={deerRef2}>
        <div
          ...
          style={{
            ...
            height: `${imageSize.height}px`,
            background: 'url(images/dolphinhead.png) no-repeat',
            backgroundSize: 'contain',
          }}
        />
      </Draggable>
